...
def compare(user_score,computer_score):
    if computer_score == user_score:
        ...
        print("You wins with blackjack")
    elif user_score >21:
        print("You lost with out of range")
    elif computer_score >21:
        print("Computer lost with out of range")
    elif computer_score>user_score:
        print("Computer wins with high score than you")
    else:
        print("You wins with high score than computer")
...
def play_game():
    ...
    while not is_gameover:
        ...
        print(f"Your card:{user_cards} and Your score:{user_score}")
        ...
        #Hint 10: If the game has not ended, ask the user if they want to draw another card. If yes, then use the deal_card() function to add another card to the user_cards List. If no, then the game has ended.
            ...
            another_dealCard=input("type y to hit another card , and n to pass")
            if another_dealCard=="y":
                user_cards.append(deal_card())
            else:
                is_gameover=True
...
while input("Enter y to start the game and n to stop the game: ")=="y":
    play_game()
